...
def make_ui():
    return ui.page_sidebar(
        ...
        #######################################################################
        ui.sidebar(
            ui.input_text_area("genes","Gene names (comma or newline separated)",
            ...
            ui.input_select("metric","Value to plot",
                            choices={"p":"p-value","q":"q-value (FDR)"}, selected="p"),
        ...
        ui.div(
            ...
            ui.card(
                ...
                ui.navset_pill(
                    ui.nav_panel("Continuous variables (CVs)", ui.output_table("tbl_continuous")),
